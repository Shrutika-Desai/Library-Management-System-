...
namespace Library_System
{
    class dbcodeclass
    {
         ...
         public dbcodeclass()
            {
                cn = new SqlConnection(@"Data Source=.\SQLEXPRESS;AttachDbFilename=C:\Users\Project\Library_System\Library_System\Database1.mdf;Integrated Security=True;User Instance=True");
                cn.Open();
            }
